...
namespace OTUI {
    ...
    struct AnchorBinding {
        ...
        bool isValid() const { return edge != AnchorEdge::None && !targetId.isEmpty(); }
    };
    ...
    public:
        ...
        Widget(QString widgetId, QString dataPath);
    ...
    public:
        ...
        void setVisibleProperty(bool visible) { m_visible = visible; }
        ...
        void setImageSource(const QString &source, const QString &dataPath = QString());
        ...
        virtual bool supportsTextProperty() const;
        virtual QString textProperty() const;
        virtual void setTextProperty(const QString &text);

        Qt::Alignment textAlignment() const { return m_textAlign; }
        void setTextAlignment(Qt::Alignment alignment) { m_textAlign = alignment; }
        QPoint textOffset() const { return m_textOffset; }
        void setTextOffset(const QPoint &offset) { m_textOffset = offset; }
        bool textAutoResize() const { return m_textAutoResize; }
        void setTextAutoResize(bool enabled) { m_textAutoResize = enabled; }
        bool textWrap() const { return m_textWrap; }
        void setTextWrap(bool enabled) { m_textWrap = enabled; }

        const EdgeGroup<int> &margin() const { return m_margin; }
        void setMargin(int value) { m_margin.set(value); }
        void setMarginLeft(int value) { m_margin.left = value; }
        void setMarginRight(int value) { m_margin.right = value; }
        void setMarginTop(int value) { m_margin.top = value; }
        void setMarginBottom(int value) { m_margin.bottom = value; }

        const EdgeGroup<int> &padding() const { return m_padding; }
        void setPadding(int value) { m_padding.set(value); }
        void setPaddingLeft(int value) { m_padding.left = value; }
        void setPaddingRight(int value) { m_padding.right = value; }
        void setPaddingTop(int value) { m_padding.top = value; }
        void setPaddingBottom(int value) { m_padding.bottom = value; }
        ...
        void clearAnchors();
        void setAnchorBinding(AnchorEdge edge, const QString &targetId, AnchorEdge targetEdge);
        void clearAnchorBinding(AnchorEdge edge);
        AnchorBinding anchorBinding(AnchorEdge edge) const;
        QString anchorDescriptor(AnchorEdge edge) const;
        bool setAnchorFromDescriptor(AnchorEdge edge, const QString &descriptor);
        QString centerInTarget() const;
        void setCenterInTarget(const QString &targetId);
        QString fillTarget() const;
        void setFillTarget(const QString &targetId);
        void applyAnchors(const std::function<Widget*(const QString&)> &resolver);
    ...
    protected:
        ...
        Qt::Alignment m_textAlign = Qt::AlignLeft | Qt::AlignVCenter;
        QPoint m_textOffset = QPoint(0, 0);
        bool m_textAutoResize = false;
        ...
        AnchorBinding m_anchorLeft;
        AnchorBinding m_anchorRight;
        AnchorBinding m_anchorTop;
        AnchorBinding m_anchorBottom;
        AnchorBinding m_anchorHorizontalCenter;
        AnchorBinding m_anchorVerticalCenter;
    };
